...
import { KPI, Customer, ContractWarning, SoftwareType, MonthlyData, ContractStatus, Contract, MasterDataCustomer, MasterDataGeneric, CategoryDefinition, SystemUser, AuditLogEntry, ProfitData, RevenueBySoftware, MasterDataSupplier, UserGroup, PermissionNode } from './types';
